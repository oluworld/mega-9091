 ...
 *    Hare Krishna
    ...
    public static void main(String argv[]) {
        ...
        for (int i = 0; i < argv.length; i++) {
            if (argv[i].equals("-cfgdir")) {
            ...
            } else if (argv[i].equals("-killunref")) {
                ACT |= ACT_KILLUNREF | ACT_EXIT;
            } else if (argv[i].equals("-ro") || argv[i].equals("-cdrom")
                ...
                if (i + 2 < argv.length && !argv[i + 1].startsWith("-")
                    ...
                    } else if (argv[i].indexOf("lru") > 0) {
                        type = garbage.EXPORT_LRU;
                    }
            ...
            } else if (argv[i].equals("-rebalance")) {
                ACT |= ACT_REBALANCE | ACT_EXIT;
            } else if (argv[i].equals("-fakegc")) {
                ACT |= ACT_FAKEGC | ACT_EXIT;
            } else if (argv[i].equals("-faststart")) {
                faststart = true;
