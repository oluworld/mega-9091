...
// $Id: HiStore_J2.java,v 1.1 2005/08/08 02:31:59 olu Exp $
...
//			R = null;
    ...
    /**
     * return an the entry associated with akey. it may exist already in
     * entrymap
     *
     * @param aKey goes into entries field.
     * @throws tripleo.histore.AllocationFailure if the system rejects our
     * request
     * @throws tripleo.histore.ConsistencyFailure if the filesystem reports an
     * error
     */
    ...
    /**
     * Answers a fresh entry to have #get{Meta,Content}Writer called, with empty
     ...
     * @throws tripleo.histore.ConsistencyFailure The reason will be UNIQ if the
     * key already exists
     */
    ...
    /**
     * Tell the system to update its entry index Our prevalent system will
     * allocate #r for the callers' exclusive usage
     * <p/>
    ...
    /**
     * Tell the system that we wish to use this number #r Our prevalent system
     * will allocate #r for the callers' exclusive usage
     *
...
//		dirty = new Vector<HiStoreEntry_J2>();
     ...
     * @param m if this is not null, start a cleaner thread note that this
     * behavoir is undefined (untested)
     * @return
