...
//		Py.println(frame.getname("yaml").__getattr__("load").__call__(frame.getname("open").__call__(s$3).invoke("read")));
    ...
    public J2_System.lazyEntry get(String aKey) {
        return _m.get(aKey);
    }

    public boolean containsKey(String aKey) {
        return _m.containsKey(aKey);
    }

    public Map<String, J2_System.lazyEntry> unmodifiable() {
        return Collections.unmodifiableMap(_m);
    }
