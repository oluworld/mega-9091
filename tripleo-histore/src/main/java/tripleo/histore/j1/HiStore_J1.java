...
// $Id: HiStore_J1.java,v 1.2 2005/08/08 02:31:59 olu Exp $
public class HiStore_J1 implements HiStore {
    ...
    String getFileName(long identifier, char aFor) {
        final File R = new File(backing, mangle_name(identifier, aFor));
        return R.toString();
    }
...
//			R = null;
     ...
     * @throws ConsistencyFailure The reason will be UNIQ if the key already
     * exists
     */
