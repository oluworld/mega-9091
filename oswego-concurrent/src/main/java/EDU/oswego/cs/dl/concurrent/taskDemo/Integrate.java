...
/**
 * Sample program using Guassian Quadrature for numerical integration. Inspired
 * by a
...
public class Integrate {
    ...
    /**
     * Sample from filaments demo. Computes (2*n-1)*(x^(2*n-1)) for all odd
     * values
     *
     */
    ...
    static class Integrator {
        ...
        /**
         * FJTask to recursively perform the quadrature. Algorithm: Compute the
         * area from lower bound to the center point of interval, and from the
         * center point to the upper bound. If this differs from the value from
         * lower to upper by more than the error tolerance, recurse on each
         * half.
         *
         */
