 ...
 *   }
 * }
 * </pre> Syncs may be used in somewhat tedious but more flexible replacements
 ...
 * }
 * </pre> If you have a lot of such methods, and they take a common form, you
 * can standardize this using wrappers. Some of these wrappers are standardized
 ...
 *   }
 * }
 * </pre> <p> In addition pure synchronization control, Syncs may be useful in
 * any context requiring before/after methods. For example, you can use an
 * ObservableSync (perhaps as part of a LayeredSync) in order to obtain
 * callbacks before and after each method invocation for a given class. <p>
 *
 * <p> [ <a href="http://gee.cs.
 * o
 * s
 * w
 * e
 * g
 * o.edu/dl/classes/EDU/oswego/cs/dl/util/concurrent/intro.html">
...
public interface Sync {
     ...
     * equal to zero means not to wait at all. However, this may still require
     * access to a synchronization lock, which can impose unbounded delay if
