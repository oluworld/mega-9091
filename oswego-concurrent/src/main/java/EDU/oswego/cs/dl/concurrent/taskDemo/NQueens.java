...
class NQueens extends FJTask {
    ...
    /**
     * Global variable holding the result of search. FJTasks check this to see
     * if it is nonnull, if so, returning early because a result has been found.
     * In a more serious program, we might use a fancier scheme to reduce
     * read/write pressure on this variable.
     *
     */
