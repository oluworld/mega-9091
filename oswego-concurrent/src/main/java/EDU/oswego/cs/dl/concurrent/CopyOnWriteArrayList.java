...
public class CopyOnWriteArrayList implements List, Cloneable, java.io.Serializable {
    ...
    /**
     * Replace the held array with a copy of the <code>n</code> elements of the
     * provided array, starting at position <code>first</code>. To copy an
     * entire array, call with arguments (array, 0, array.length).
     *
     * @param toCopyIn the array. A copy of the indicated elements of this array
     * is used as the internal array.
     * @param first The index of first position of the array to start copying
     * from.
     * @param n the number of elements to copy. This will be the new size of the
     * list.
     *
     */
     ...
     * @param index the index to start searching from.
     * @return the index of the last occurrence of the specified object in this
     * List at position less than index in the List; -1 if the object is not
     * found.
     */
     ...
     * useful in determining the length of the list <em>only</em> if the caller
     ...
     * @exception IndexOutOfBoundsException index is out of range (index &lt; 0
     * || index &gt;= size()).
     */
     ...
     * @exception IndexOutOfBoundsException index out of range (index &lt; 0 ||
     * index &gt;= size()).
     */
     ...
     * elements. Returns true if the Collection contained the specified element
     ...
     * @exception IndexOutOfBoundsException fromIndex or toIndex out of range
     * (fromIndex &lt; 0 || fromIndex &gt;= size() || toIndex &gt; size() ||
     * toIndex &lt; fromIndex).
     */
     ...
     * <em>equal</em> if <code>(e1==null ? e2==null : e1.equals(e2))</code>.) In
     * other words, two Lists are defined to be equal if they contain the same
     ...
     * the iterator. The iterator does
     * <em>NOT</em> support the <code>remove</code>, <code>set</code>, or
     ...
     * set and add methods.
     *
     * @param index index of first element to be returned from the ListIterator
    ...
    protected static class COWIterator implements ListIterator {
         ...
         *
         * @exception UnsupportedOperationException remove is not supported by
         * this Iterator.
         */
        public void remove() {
         ...
         * Not supported. Always throws UnsupportedOperationException.
         *
         * @exception UnsupportedOperationException set is not supported by this
         * Iterator.
         */
