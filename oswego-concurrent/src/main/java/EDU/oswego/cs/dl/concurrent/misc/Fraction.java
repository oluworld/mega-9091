...
/**
 * An immutable class representing fractions as pairs of longs. Fractions are
 * always maintained in reduced form.
 *
 */
public class Fraction implements Cloneable, Comparable, java.io.Serializable {
    ...
    /**
     * Compute the nonnegative greatest common divisor of a and b. (This is
     * needed for normalizing Fractions, but can be useful on its own.)
     *
     */
    ...
    /**
     * return a number less, equal, or greater than zero reflecting whether this
     * Fraction is less, equal or greater than the value of Fraction other.
     *
     */
    ...
    /**
     * return a number less, equal, or greater than zero reflecting whether this
     * Fraction is less, equal or greater than n.
     *
     */
