...
public class ClockDaemon extends ThreadFactoryUser {
     ...
     *
     * @param date -- the absolute time to run the command, expressed as a
     * java.util.Date.
     ...
     * <p>
     * <b>Sample Usage.</b>
     * You can use a ClockDaemon to arrange timeout callbacks to break out of
     * stuck IO. For example (code sketch):
     * <pre>
     * class X {   ...
     *
     *   ClockDaemon timer = ...
     ...
     * </pre>
     *
     * @param millisecondsToDelay -- the number of milliseconds from now to run
     * the command.
     ...
     * <p>
     * <b>Sample Usage</b>. Here is one way to update Swing components acting as
     ...
     *   }
     * }
     * </pre> @param period -- the period, in milliseconds. Periods are measured
     * from start-of-task to the next start-of-task. It is generally a bad idea
     * to use a period that is shorter than the expected task duration.
     *
     * @param command -- the command to run at each cycle
     * @param startNow -- true if the cycle should start with execution of the
     * task now. Otherwise, the cycle starts with a delay of <code>period</code>
     * milliseconds.
     ...
     * @exception ClassCastException if the taskID argument is not of the type
     * returned by an execute command.
     *
     */
