...
public class BarrierJacobi {
    ...
    /**
     * The maximum submatrix length (both row-wise and column-wise) for any
     * Segment
     *
     */
    ...
    static class Segment implements Runnable {
        ...
        void convergenceCheck(int step) {
            ...
            for (Segment allSegment : allSegments) {
                allSegment.converged = true;
            }
        }
