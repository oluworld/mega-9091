...
public class Ball implements Runnable
{
	...
	private int delay_time;		// Sleep-time of thread.
	...
	private Component area;		// The area where the ball bounces.
	public Thread runner;		// The Thread.
	private AudioClip sndWall;	// Sound when ball hits wall.
	private AudioClip sndPaddle;// Sound when ball hits paddle.
	private Graphics gr;		// Something to draw on.
	private Paddle paddle;		// The paddle to bounce on.
