...
public class Utils {
    ...
    /**
     * Replaces all occurences of key in input by replacement RDFValidator was
     * using Jakarta's regexp package to do the same thing - rewrote a similar
     * function so that we do not need users to install Jakarta
     */
