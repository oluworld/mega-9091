...
class ButtonTab extends AlignableTab {
	...
	void createStyleGroup() {
		...
		pushButton = new Button(styleGroup, 16);		pushButton.setText("SWT.PUSH");
		checkButton = new Button(styleGroup, 16);		checkButton.setText("SWT.CHECK");
		radioButton = new Button(styleGroup, 16);		radioButton.setText("SWT.RADIO");
		toggleButton = new Button(styleGroup, 16);		toggleButton.setText("SWT.TOGGLE");
		arrowButton = new Button(styleGroup, 16);		arrowButton.setText("SWT.ARROW");
		flatButton = new Button(styleGroup, 32);		flatButton.setText("SWT.FLAT");
		borderButton = new Button(styleGroup, 32);		borderButton.setText("SWT.BORDER");
	}
