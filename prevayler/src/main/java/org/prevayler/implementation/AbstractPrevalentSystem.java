...
/**
 * An implementation of the PrevalentSystem interface to be extended, if
 * convenient. It takes care of the clock methods. It is not necessary that
 * PrevalentSystems extend this class.
 */
