 ...
 * persisted. Only client code that takes the snapshots, like this class, needs
 * to know about the SnapshotPrevayler class. All other client code, like the
 * PrimeCalculator, needs to know only about the Prevayler interface.
 */
