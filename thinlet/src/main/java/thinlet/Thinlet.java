...
//midp public class Thinlet extends Canvas implements CommandListener {
     ...
     * disabled controls, not editable texts, lines between list items (the
    ...
    private void doLayout(Object component) {
        ...
        if ("combobox" == classname) {
            ...
            r.height = ph + 2;
            if (combo) {
                r.width = Math.max(r.width, getRectangle(pr, "bounds").width);
            }
            if (combo) {
    ...
    /**
     * Gets the index of the first selected item in the given component (list,
     * table, or tree)
     *
     * @param component a widget
    ...
    /**
     * Gets the first selected item of the given component (list, table, or
     * tree)
     *
     * @param component a widget
     ...
     * resource to bind a string value, the format is:
     ...
     * path starts with an <i>/</i> character)
     ...
     * <i>getDOMAttribute</i>, <i>getDOMText</i>,
     * <i>getDOMCount</i>, <i>getDOMNode</i>, <i>getClass</i>, and
     * <i>getParent</i> methods to analise the document
     *
     * @param inputstream e.g. <i>new
     * URL("http://myserver/myservlet").openStream()</i>
     * @return the root tag
    ...
    private Object parse(InputStream inputstream,
        ...
        Reader rreader = new BufferedReader(new InputStreamReader(inputstream)); //java
        KW reader = new KW(rreader);
    ...
    private void addImpl(Object parent, Object component, int index) {
        ...
        if ((("combobox" == parentclass) && ("choice" == classname))
            ...
            while ("component" != classname) {
                ...
                if (extendclass == null) {
                    throw new IllegalArgumentException(classname + " not component");
                }
    ...
    private Object addElement(Object parent, String name) {
        System.err.println("5263 addElement '" + name + "' to " + java.util.Arrays.asList((Object[]) parent));
    ...
    private Object[] getDefinition(Object component, String key, String type) {
        ...
        throw new IllegalArgumentException("unknown dtd element " + key + " of " + type
                + " for " + currentname);
    }
     ...
     * mybutton, mybutton.enabled)</i>
     * for <i>public void foo(Object component, String text, Object mybutton,
     * boolean enabled)</i>)
     ...
     *
     * @param path is relative to your thinlet instance or the classpath (if the
     * path starts with <i>'/'</i> character)
     ...
     * repaints, and updates the layout) only when required (painted, or size
     * requested) if false
     * @return the loaded image or null
     */
    ...
    static {
        ...
        dtd = new Object[]{
            ...
            "button", "label", new Object[][]{
                ...
                {"method", "action", "", null}, //{ "choice", "type", "", new String[] { "normal", "default", "cancel" } }
            },//...
