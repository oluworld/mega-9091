...
/**
 * new game gui dialog where you can enter your name and select the level you
 * want to play
 */
...
//	private JPanel mainPanel = new JPanel();
    ...
    /**
     * Read all levels from the level dir and add to combobox. Level files is
     * all files with extention .lev
     */
...
//		String files[] = dir.list();
    ...
    /**
     * check the length of the name and cut it if it's to long so it dont mess
     * up the highscore totaly
     */
