...
/**
 * Player gameobject this is that game object that you controle in the game.
...
//	private Timer timer = new Timer();
    ...
    /**
     * draw the player object on screen and the hearts at the bottom of the
     * screen
     */
    public void draw(Graphics g, java.awt.image.ImageObserver imgObs) {
        ...
        if (!killable) {
            g.drawImage(Gfx.siren_img, 140, 418, imgObs);
        }
    ...
    /**
     * set the nummber of coins the player have to collect before he is done on
     * the specified level
     */
    ...
    /**
     * return true if the player has collected all the coins on the level.
     */
    ...
    /**
     * return true if the player is possible to kill or not used for siren sound
     */
