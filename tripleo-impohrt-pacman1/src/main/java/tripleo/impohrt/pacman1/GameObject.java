...
/**
 * GameObject class is a abstract class that contin stuff that all our
 * gameobjects need.
 */
abstract class GameObject {
    ...
    /**
     * tick method that all gameobjects over-ride take care of the movement of
     * gameobjects
     */
    public void tick() {
    }
    ...
    /**
     * draw method that every gameobject over-ride. take care of the
     */
