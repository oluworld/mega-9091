...
public class Handle {
    ...
    public static void main(String[] var0) throws Exception {
        ...
        Py.runMain(Handle._PyInner.class, var1, jpy$packages, jpy$properties, "mail98.DBi", new String[]{"DBi.Server", "etoffiutils", "DBi.Handle", "javapath", "MMS", "traceback", "stat", "string", "linecache", "DBi.__init__", "javaos", "rfc822"});
    }
