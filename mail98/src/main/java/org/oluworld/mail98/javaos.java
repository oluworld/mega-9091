...
public class javaos extends java.lang.Object {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Py.runMain(javaos._PyInner.class, newargs, jpy$packages, jpy$properties, "mail98", new String[]{"DBi.Server", "etoffiutils", "DBi.Handle", "javapath", "MMS", "traceback", "stat", "string", "linecache", "DBi.__init__", "javaos", "rfc822"});
    }
