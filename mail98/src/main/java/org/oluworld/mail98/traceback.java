...
public class traceback extends java.lang.Object {
    ...
    public static class _PyInner extends PyFunctionTable implements PyRunnable {
            ...
            if (frame.getlocal(1)._is(frame.getglobal("None")).__nonzero__()) {
                ...
                if (frame.getlocal(0)._is(frame.getglobal("SyntaxError")).__nonzero__()) {
                    ...
                    try {
                        ...
                        t$1$PyObject = t$0$PyObject.__getitem__(1);
                        frame.setlocal(8, t$1$PyObject.__getitem__(0));
        ...
        private static PyObject print_exc$11(PyFrame frame) {
            ...
            try {
                t$0$PyObject = frame.getglobal("sys").__getattr__("exc_info").__call__();
                frame.setlocal(3, t$0$PyObject.__getitem__(0));
    ...
    public static void main(String[] args) {
        ...
        Py.runMain("mail98.traceback$_PyInner", newargs, jpy$packages, jpy$properties, "mail98", new String[] {"DBi.Server", "etoffiutils", "DBi.Handle", "javapath", "MMS", "traceback", "stat", "string", "linecache", "DBi.__init__", "javaos", "rfc822"});
    }
