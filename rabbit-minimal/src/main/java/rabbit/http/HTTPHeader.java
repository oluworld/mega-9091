...
public class HTTPHeader extends GeneralHeader {
    ...
    /**
     * Set the content for the request/response This is a way to set up handling
     * of a chunked input request As a side effect the
     * &quot;Transer-Encoding&quot; header is also set.
     *
