...
abstract public class GeneralHeader implements Serializable {
    ...
    /**
     * Read in this header from the given Stream. This actually merges the
     * current header with the one beeing read.
     *
    ...
    /**
     * Read in this header from the given Stream. This actually merges the
     * current header with the one beeing read. This method is a convinience to
     * have the abbility to read past the initial data before the header is
     * read.
     *
     * @param in the Stream to read the header from.
