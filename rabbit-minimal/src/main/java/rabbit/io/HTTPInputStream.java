 ...
 *
 * If the underlying input is chunked this class will throw away any trailing
 * footer.
 */
...
//	private long readBytes = 0;
    ...
    /**
     * Read a HTTPHeader of this stream. If data is chunked the whole page will
     * be read in so to get it use the getChunkStream. something like this <xmp>
     * HTTPHeader header = readHeader (); if (chunked) { contentStream =
     * getChunkStream (); }
     * </xmp>
     *
