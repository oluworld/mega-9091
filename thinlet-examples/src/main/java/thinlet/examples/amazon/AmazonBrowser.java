package thinlet.examples.amazon;
...
public class AmazonBrowser extends Thinlet {
    ...
    private void showException(Throwable exc) {
        ...
        setInteger(dialog, "columns", 1);
        setInteger(dialog, "gap", 4);
        setInteger(dialog, "top", 4);
        setInteger(dialog, "left", 4);
        setInteger(dialog, "bottom", 4);
        setInteger(dialog, "right", 4);
        ...
        setInteger(textarea, "width", 240);
        setInteger(textarea, "height", 180);
        add(dialog, textarea);
